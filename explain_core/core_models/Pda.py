...
class Pda(BaseModel):
    ...
    def calc_model(self) -> None:
        ...
        if self._diameter_stepsize != 0:
            ...
            if abs(self._current_diameter - self._target_diameter) < abs(self._diameter_stepsize):
    ...
    def open_ductus(self, new_diameter = 2.5, in_time: float = 5.0, at_time: float = 0.0):
        ...
        self._diameter_stepsize = ((self._target_diameter - self._current_diameter) / self._in_time) * self._t
