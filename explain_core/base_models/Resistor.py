...
class Resistor(BaseModel):
    ...
    r_for_scaling_factor: float = 1.0
    r_back: float = 1.0
    r_back_factor: float = 1.0
    r_back_scaling_factor: float = 1.0
    r_k: float = 0.0
    r_k_factor: float = 1.0
    r_k_scaling_factor: float = 1.0
    r_ext: float = 0.0
    ...
    def calc_model(self) -> None:
        ...
        _rfor_base = self.r_for * self.r_for_factor * self.r_for_scaling_factor
        rfor: float = (
            _rfor_base
            + (self.r_ans_factor * _rfor_base - _rfor_base) * self.ans_activity_factor
        ...
        _rback_base = self.r_back * self.r_back_factor * self.r_back_scaling_factor
        rback: float = (
            _rback_base
            + (self.r_ans_factor * _rback_base - _rback_base) * self.ans_activity_factor
