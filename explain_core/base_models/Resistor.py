...
class Resistor(BaseModel):
    ...
    def calc_model(self) -> None:
        ...
        _r_for_base = self.r_for * self.r_for_factor * self.r_scaling_factor
        r_for: float = (
            _r_for_base
        ...
        _r_back_base = self.r_back * self.r_back_factor * self.r_scaling_factor
        r_back: float = (
            _r_back_base
        ...
        # flow is in l/s
        if self.area > 0:
            self.velocity = (self.flow * 0.01) / self.area
