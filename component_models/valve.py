...
class Valve(BaseModel):
	...
	def init_model(self, args=None):
		...
		# validate that the component has valid connections
		if not self.comp_from or not self.comp_to:
			raise ValueError(f"Valve {self.name} must have valid comp_from and comp_to properties")
